...
import FavoriteCountry from '../../../src/app/components/FavoriteCountry';
...
describe('FavoriteCountry Integration Test', () => {
  it('renders DataPanel with correct header when permission is granted', () => {
    ...
    render(
      <Provider store={store}><FavoriteCountry /></Provider>
    );
    // Check DataPanel header
    expect(screen.getByTestId('Favorite Country')).toBeInTheDocument();
  });
});
