...
import CPETechnicalDetails from '../../../src/app/components/ManagedServices/CPETechnicalDetails';
...
describe('CPETechnicalDetails Integration Test', () => {
  it('renders DataPanel with Managed Services Data Port Details header', () => {
    ...
    render(
      <Provider store={store}><CPETechnicalDetails /></Provider>
    );
